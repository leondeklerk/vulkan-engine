...
namespace ve {
	...
	void SimpleRenderSystem::createPipeline(VkRenderPass renderPass)
	{
		...
		VePipeline::defaultPipelineConfigInfo(pipelineConfigInfo);
		pipelineConfigInfo.renderPass = renderPass;
		pipelineConfigInfo.pipelineLayout = pipelineLayout;
		vePipeline = std::make_unique<VePipeline>(veDevice, "simple_shader.vert.spv", "simple_shader.frag.spv", pipelineConfigInfo);
	}
